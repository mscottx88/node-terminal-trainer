...
function TabView(
  ...
  Object.assign(this, { animate, escapable, modal, showHelpArea, useTabIndex });
  ...
  Object.defineProperty(this, 'internalHeight', {
    get: () => this.sdiArea.height
  });

  Object.defineProperty(this, 'internalWidth', {
    get: () => this.sdiArea.width
  });
...
TabView.prototype.helpHandler = function () {
  // @todo the focused element may not contain helplines, but its parent might...
  if (this.scnMain.focused && this.scnMain.focused.options.helpLines) {
    this.pnlHelp.setContent(this.scnMain.focused.options.helpLines.join(os.EOL));
  } else {
    this.pnlHelp.setContent('Help not defined for this element');
  }
}
...
TabView.prototype.makeElementHelpable = function (
  {
    element
  } = {}
) {
...
TabView.prototype.defineScreenElements = function () {
  ...
  this.sdiArea = new blessed.Box({
    screen: this.scnMain,
    parent: this.sdiRoot,
    height: `100%${this.showHelpArea ? '-7' : '-2'}`
  });
...
TabView.prototype.sdiArea_onAdopt = function (element) {
  if (this.useTabIndex) {
    this.addTabbableElement({ element });
  }
  if (this.escapable) {
